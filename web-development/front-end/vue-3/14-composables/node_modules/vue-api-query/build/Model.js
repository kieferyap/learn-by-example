...
var Model = /*#__PURE__*/function (_StaticModel) {
  ...
  (0, _createClass2["default"])(Model, [{
    ...
    value: function stringifyOptions() {
      return {
        arrayFormat: 'comma'
      };
    }
      ...
      for (var _i = 0, _Object$keys = Object.keys(relations); _i < _Object$keys.length; _i++) {
        ...
        if (Array.isArray(_relation.data) || Array.isArray(_relation)) {
          ...
          if (_relation.data !== undefined) {
            ...
            (0, _dset.dset)(model, relation, collection);
          }
        } else {
          (0, _dset.dset)(model, relation, this._applyInstance(_relation, relations[relation]));
        }
      }
    }
  }, {
    ...
    value: function _reqConfig(config) {
      ...
      var _config = (0, _defu.defu)(this._config, config); // Prevent default request method from being overridden
