...
var Builder = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(Builder, [{
    ...
    value: function _nestedFilter(keys, value) {
      ...
      (0, _dset.dset)(_value, keys, value);
      return [_key, _value];
    }
    /**
     * Query builder
    ...
    value: function where(key, value) {
      if (key === undefined || (0, _typeof2["default"])(key) !== 'object' && value === undefined) {
      ...
      if (Array.isArray(key)) {
        ...
        this.filters = _objectSpread({}, this.filters, {}, key);
      } else {
    ...
    value: function whereIn(key, array) {
      if ((0, _typeof2["default"])(key) !== 'object' && !Array.isArray(array)) {
        throw new Error('The second argument on whereIn() method must be an array.');
      }

      if (Array.isArray(key)) {
        var _this$_nestedFilter3 = this._nestedFilter(key, array),
    ...
    value: function when(value, callback) {
      if (typeof callback !== 'function') {
        throw new Error('The CALLBACK is required and must be a function on when() method.');
      }
